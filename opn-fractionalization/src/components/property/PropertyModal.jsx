...
const PropertyModal = ({ property, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-black border border-neutral-900 rounded-sm max-w-4xl w-full max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="sticky top-0 bg-black z-10 flex items-center justify-between p-6 border-b border-neutral-900">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-neutral-950 rounded-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium text-lg">{totalCost} OPN</span>
                    </div>
                  </div>
